...
#define DOWN_ARROW_TOUCH  TOUCH_PAD_NUM1 // DOWN ARROW is TOUCH PAD 1
#define RIGHT_ARROW_TOUCH TOUCH_PAD_NUM2 // RIGHT ARROW is TOUCH PAD 2
#define UP_ARROW_TOUCH    TOUCH_PAD_NUM3 // UP ARROW is TOUCH PAD 3
#define LEFT_ARROW_TOUCH  TOUCH_PAD_NUM4 // LEFT ARROW is TOUCH PAD 4
