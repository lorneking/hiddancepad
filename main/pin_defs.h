...
#define UP_ARROW_TOUCH  TOUCH_PAD_NUM4 // DOWN ARROW is TOUCH PAD 1
#define RIGHT_ARROW_TOUCH TOUCH_PAD_NUM6 // RIGHT ARROW is TOUCH PAD 2
#define DOWN_ARROW_TOUCH    TOUCH_PAD_NUM7 // UP ARROW is TOUCH PAD 3
#define LEFT_ARROW_TOUCH  TOUCH_PAD_NUM5 // LEFT ARROW is TOUCH PAD 4
